...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="McPicker",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8McPicker8McPicker")
@interface McPicker : UIView
...
@interface McPicker (SWIFT_EXTENSION(McPicker)) <UITextFieldDelegate>
...
@interface McPicker (SWIFT_EXTENSION(McPicker)) <UIGestureRecognizerDelegate>
- (BOOL)gestureRecognizer:(UIGestureRecognizer * _Nonnull)gestureRecognizer shouldReceiveTouch:(UITouch * _Nonnull)touch SWIFT_WARN_UNUSED_RESULT;
@end

@class UIPickerView;

@interface McPicker (SWIFT_EXTENSION(McPicker)) <UIPickerViewDelegate>
...
@interface McPicker (SWIFT_EXTENSION(McPicker)) <UIPickerViewDataSource>
...
@interface McPicker (SWIFT_EXTENSION(McPicker)) <UIPopoverPresentationControllerDelegate>
...
SWIFT_CLASS("_TtC8McPicker21McPickerBarButtonItem")
@interface McPickerBarButtonItem : UIBarButtonItem
- (nonnull instancetype)init OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)aDecoder OBJC_DESIGNATED_INITIALIZER;
@end


SWIFT_CLASS("_TtC8McPicker11McTextField")
